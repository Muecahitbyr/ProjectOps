import type { CheckStatus, IncidentSeverity } from "./common.types";

// Spiegelt src/types/analytics.types.ts im Backend - Werte kommen 1:1 aus
// der API, siehe api/analytics.api.ts.
